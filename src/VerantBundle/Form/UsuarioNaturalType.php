...
class UsuarioNaturalType extends AbstractType {
...
//                ))
                ...
                ->add('imagenCi', 'file', array(
                    'required' => false,
                    'data_class' => null,
                    'label' => 'Cédula de Identidad',
                    'attr' => array('class' => 'custom-file-upload', 'id' => 'fileCi', 'data-btn-text' => "Seleccione un Archivo")
                ))
                ->add('terminos', 'file', array(
                    'required' => false,
                    'data_class' => null,
                    'label' => 'Términos y Condiciones',
                    'attr' => array('class' => 'custom-file-upload', 'id' => 'fileTerminos', 'data-btn-text' => "Seleccione un Archivo")
                ))
                ->add('roles', 'hidden', array('data' => 'ROLE_USER'))
                ->add('tipo', 'hidden', array('data' => 'USU_NAT'))
